...
(function($) {
	...
	$.fn.easySlider = function(options){
		...
		var defaults = {
			prevId: 		'prevBtn',
			prevText: 		'<img src="/images/PlayLeftArrow.png" width="27" height="25" alt="" align="absmiddle">',
			nextId: 		'nextBtn',	
			nextText: 		'<img src="/images/PlayRightArrow.png" width="27" height="25" alt="" align="absmiddle">',
